...
var Progress = {
    ...
    addProgress : function (canvas) {
        ...
        canvas.insertAdjacentHTML('beforebegin', '<div id="' + Progress.progress_id + '" class="canvas-app-progress"><div id="' + Progress.bar_id + '" class="canvas-app-progress-bar" style="width: 0%;"></div></div>');
